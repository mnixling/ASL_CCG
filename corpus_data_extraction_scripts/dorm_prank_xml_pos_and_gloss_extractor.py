...
with open(partial_path + r'\dorm prank.xml', 'r') as f_IN:
    ...
    # Lines 44-73 is only for dominant hand gloss
    for utterance_tag in soup.find_all('UTTERANCE'):
        for dominant_track_tags in utterance_tag.find_all('TRACK', {'FID': '10000'}):
            for dominant_a_tags in dominant_track_tags.find_all('A'):
                ...
                elif ('5' in dominant_a_tags.string) and ('CL' not in dominant_a_tags.string) and ('WHY' not in dominant_a_tags.string):
                ...
                elif '\"gees\"' in dominant_a_tags.string:
                    dominant_hand_gees = dominant_a_tags.string
                    dominant_hand_unlabeled_gloss_list.append(dominant_hand_gees)
                elif '\"oh my god\"' in dominant_a_tags.string:
                    dominant_hand_oh_my_god = dominant_a_tags.string
                    dominant_hand_unlabeled_gloss_list.append(dominant_hand_oh_my_god)
                ...
                elif '(2h)\"not give a darn\"' in dominant_a_tags.string:
                    dominant_hand_not_give_a_darn = dominant_a_tags.string
                    dominant_hand_unlabeled_gloss_list.append(dominant_hand_not_give_a_darn)
                elif re.search('fs-B$', dominant_a_tags.string):
                    dominant_hand_fs_B = dominant_a_tags.string
                    dominant_hand_unlabeled_gloss_list.append(dominant_hand_fs_B)
                else:
        ...
        # Lines 76-103 is only for non-dominant hand gloss
        for non_dominant_track_tags in utterance_tag.find_all('TRACK', {'FID': '10001'}):
            for non_dominant_a_tags in non_dominant_track_tags.find_all('A'):
                ...
                elif '5\"exasperation\"' in non_dominant_a_tags.string:
                    non_dominant_5_exasperation = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_5_exasperation)
                elif '5\"frustration\"' in non_dominant_a_tags.string:
                    non_dominant_5_frustration = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_5_frustration)
                elif '5\"hesitation\"' in non_dominant_a_tags.string:
                    non_dominant_5_hesitation = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_5_hesitation)
                ...
                elif '5\"resignation\"' in non_dominant_a_tags.string:
                    non_dominant_5_resignation = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_5_resignation)
                elif '5\"you know\"' in non_dominant_a_tags.string:
                    non_dominant_5_you_know = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_5_you_know)
                else:
...
"""Code blocks from 107 to 115 take the gloss from both the dominant and non-dominant hand and
...
# lines 118-126 arrange the output to be in <POS> <GLOSS> ordering
...
"""
Lines 134-182 arranges the output for the file pos_gloss.txt to be <POS> <GLOSS WORD>. Any whitespace that happens 
