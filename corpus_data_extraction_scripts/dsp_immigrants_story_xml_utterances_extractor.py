"""This script opens the DSP Immigrants Story.xml file and extracts all the uttered sentences. The file created contains all the utterances in the NCSLGR Corpus. 
