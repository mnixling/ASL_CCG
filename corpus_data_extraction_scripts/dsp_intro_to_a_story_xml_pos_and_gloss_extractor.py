...
with open(partial_path + r'\DSP Intro to a Story.xml', 'r') as f_IN:
    ...
    for utterance_tag in soup.find_all('UTTERANCE'):
        ...
        # Lines 58-79 is only for non-dominant hand gloss
        for non_dominant_track_tags in utterance_tag.find_all('TRACK', {'FID': '10001'}):
            for non_dominant_a_tags in non_dominant_track_tags.find_all('A'):
                ...
                elif 'B\"focus\"' in non_dominant_a_tags.string:
                    non_dominant_hand_B_focus = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_hand_B_focus)
                ...
                elif 'B-L\"focus\"' in non_dominant_a_tags.string:
                    non_dominant_hand_B_L_focus = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_hand_B_L_focus)
                elif 'H\"focus\"' in non_dominant_a_tags.string:
                    non_dominant_hand_H_focus = non_dominant_a_tags.string
                    non_dominant_hand_unlabeled_gloss_list.append(non_dominant_hand_H_focus)
...
"""Code blocks from 83 to 91 take the gloss from both the dominant and non-dominant hand and
...
# lines 94-102 arrange the output to be in <POS> <GLOSS> ordering
...
"""
Lines 110-156 arranges the output for the file pos_gloss.txt to be <POS> <GLOSS WORD>. Any whitespace that happens 
