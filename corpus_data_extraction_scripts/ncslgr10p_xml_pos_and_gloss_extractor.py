...
with open(partial_path + r'\ncslgr10p.xml', 'r') as f_IN:
    ...
    for utterance_tag in soup.find_all('UTTERANCE'):
        ...
        # Lines 61-74 is only for non-dominant hand gloss
...
"""Code blocks from 78 to 86 take the gloss from both the dominant and non-dominant hand and
...
# lines 89-97 arrange the output to be in <POS> <GLOSS> ordering
...
"""
Lines 105-153 arranges the output for the file pos_gloss.txt to be <POS> <GLOSS WORD>. Any whitespace that happens 
