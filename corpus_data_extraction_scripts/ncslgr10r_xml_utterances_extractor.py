"""This script opens the ncslgr10r.xml file and extracts all the uttered sentences. The file created contains all the utterances in the NCSLGR Corpus. 
